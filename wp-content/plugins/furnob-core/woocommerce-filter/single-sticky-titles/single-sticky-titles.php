...
## style and scripts  
*************************************************/ 
function furnob_single_sticky_titles_scripts() {
...
add_action( 'wp_enqueue_scripts', 'furnob_single_sticky_titles_scripts' );

/*************************************************
## Single Sticky Titles
*************************************************/ 
add_action('woocommerce_after_single_product','furnob_product_single_sticky_titles');
function furnob_product_single_sticky_titles(){
